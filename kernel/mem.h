...
#define MEMORY_ENTRY_NUMBER_ADDR        0x20000  // from get_memory_info
#define MEMORY_MAP_ADDR                 0x20008  // from get_memory_info
#define E820_TYPE_RAM                   1
#define KERNEL_VIRTUAL_MEMORY_START     0xffff800000000000
#define PHYSICAL_MEMORY_END             0x40000000 // 1GB in physical memory
